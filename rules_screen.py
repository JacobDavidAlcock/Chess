...
def show_rules_screen(screen, clock, width, height):
    ...
    rules_content = [
        ...
        ("• Use 'Show Hint' button for move suggestions", text_font, TEXT_COLOR),
        ("• Use 'Surrender' to resign the game", text_font, TEXT_COLOR),
        ("", text_font, TEXT_COLOR),
        ("AI Difficulty Levels:", header_font, TITLE_COLOR),
        ("• Easy: Random moves - Beginner friendly", text_font, TEXT_COLOR),
        ("• Medium: Basic AI - Learning level", text_font, TEXT_COLOR),
        ("• Hard: Advanced AI - Intermediate", text_font, TEXT_COLOR),
        ("• Expert: Strongest AI - Advanced", text_font, TEXT_COLOR),
        ("• Aggressive: Attack-focused style", text_font, TEXT_COLOR),
        ("• Defensive: Safety-focused style", text_font, TEXT_COLOR),
        ("", text_font, TEXT_COLOR),
